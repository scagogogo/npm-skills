...
var mirrorsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Fprintln(os.Stderr)
		fmt.Fprintln(os.Stderr, color.HiBlackString("  Usage: npm-crawler <command> -m <name>"))
		fmt.Fprintln(os.Stderr, color.HiBlackString("  Or:    NPM_MIRROR=<name> npm-crawler <command>"))
		fmt.Fprintln(os.Stderr)
